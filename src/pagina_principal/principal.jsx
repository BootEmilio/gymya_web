  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col">
      ...
      <nav className="absolute top-0 left-0 w-full  shadow-md p-4 flex items-center justify-between z-50">
        ...
        <button 
          onClick={loginpage} 
          className="hidden md:block bg-red-900 text-white px-4 py-2 rounded-full font-semibold hover:bg-purple-800 transition"
        >
          Iniciar sesión
        </button>
      </nav>
      ...
      <div className="flex flex-wrap mt-8 justify-center gap-20">
        ...
        <div className="max-w-sm rounded-2xl overflow-hidden shadow-lg bg-white">
          <img className="w-full h-48 object-cover" src="/src/recursos/1.jpg" alt="Gym" />
          <div className="p-4">
